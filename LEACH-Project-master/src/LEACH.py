...
class LEACHSimulation:
    ...
    def __init__(self, n=200):
        ...
        self.Enheraf = zeros(1, self.my_model.rmax + 1)    # Average energy of the alive nodes
    ...
    def __main_loop(self):
        ...
        for round_number in range(1, self.my_model.rmax + 1):
            ...
            #LEACH_plotter.start(self.Sensors,self.my_model,self.r)
    ...
    def __statistics(self, round_number):
        ...
        # Plot the nodes after each round
        LEACH_plotter.start(self.Sensors,self.my_model,round_number)

# obj=LEACHSimulation(n=10)
# obj.start()
# from LEACH_graphs import Energy_graph,LifeTime_graph
# Energy_graph(obj).plot_energy_graph()
# LifeTime_graph(obj).plot_lifetime_graph()
